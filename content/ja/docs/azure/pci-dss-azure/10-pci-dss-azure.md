...
{{< figure src="/images/pcidss/overview.png" title="Azure PCI DSS アークテクチャー図" >}}
...
要件3,4は、カード会員データをどのように保護するかを扱っている。暗号化の話である、鍵管理と会員データの暗号化の話。鍵管理は、マネージドな鍵管理(KeyVaul)を使う。
